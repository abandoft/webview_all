...
class TestNavigationDelegateApi: PigeonApiProtocolWKNavigationDelegate {
  ...
  func didFinishNavigation(
    ...
    url urlArg: String?,
    completion: @escaping (Result<Void, webview_all_wkwebview.PigeonError>) -> Void
  ) {
  ...
  func decidePolicyForNavigationAction(
    ...
    completion:
      @escaping (
        Result<
          webview_all_wkwebview.NavigationActionPolicy, webview_all_wkwebview.PigeonError
        >
      ) -> Void
  ) {
  ...
  func decidePolicyForNavigationResponse(
    ...
    completion:
      @escaping (
        Result<
          webview_all_wkwebview.NavigationResponsePolicy, webview_all_wkwebview.PigeonError
        >
      ) -> Void
  ) {
  ...
  func didReceiveAuthenticationChallenge(
    ...
    completion:
      @escaping (
        Result<
          webview_all_wkwebview.AuthenticationChallengeResponse,
          webview_all_wkwebview.PigeonError
        >
      ) -> Void
  ) {
