...
dependencies:
  webview_all: ^1.3.8
  webview_all_windows: ^1.3.8
  webview_all_linux: ^1.3.8
  webview_all_ohos: ^1.3.8
  webview_all_web: ^1.3.8
  webview_all_android: ^1.3.8
  webview_all_wkwebview: ^1.3.8
```
...
The `1.3.8` release is aligned across `webview_platform_interface` and all
`webview_all_*` packages. The wrapper depends on
`webview_platform_interface ^1.3.8`, `webview_all_android ^1.3.8`, and
`webview_all_wkwebview ^1.3.8`.
