...
public class SslErrorTest {
  ...
  public void getPrimaryError() {
    ...
    final SslError instance = mock(SslError.class);
    final SslErrorType value = com.abandoft.webview_all_android.SslErrorType.DATE_INVALID;
  ...
  public void hasError() {
    ...
    final SslError instance = mock(SslError.class);
    final SslErrorType error = com.abandoft.webview_all_android.SslErrorType.DATE_INVALID;
