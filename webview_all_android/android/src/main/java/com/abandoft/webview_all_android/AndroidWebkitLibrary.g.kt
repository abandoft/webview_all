  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?) {
    ...
    if (value is android.webkit.WebResourceRequest) {
      ...
      registrar.getPigeonApiDownloadListener().pigeon_newInstance(value) {
        ...
        is com.abandoft.webview_all_android.WebChromeClientProxyApi.WebChromeClientImpl) {
    ...
    } else if (value is com.abandoft.webview_all_android.FlutterAssetManager) {
...
abstract class PigeonApiWebView(
  ...
  abstract fun setWebChromeClient(
      pigeon_instance: android.webkit.WebView,
      client: com.abandoft.webview_all_android.WebChromeClientProxyApi.WebChromeClientImpl?
  )
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val pigeon_instanceArg =
                args[0]
                    as com.abandoft.webview_all_android.WebChromeClientProxyApi.WebChromeClientImpl
            val valueArg = args[1] as Boolean
            val wrapped: List<Any?> =
                try {
...
abstract class PigeonApiFlutterAssetManager(
  ...
  abstract fun instance(): com.abandoft.webview_all_android.FlutterAssetManager
   ...
   */
  abstract fun list(
      pigeon_instance: com.abandoft.webview_all_android.FlutterAssetManager,
      path: String
  ): List<String>
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg =
                args[0] as com.abandoft.webview_all_android.FlutterAssetManager
  ...
  fun pigeon_newInstance(
      pigeon_instanceArg: com.abandoft.webview_all_android.FlutterAssetManager,
      callback: (Result<Unit>) -> Unit
  ) {
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
