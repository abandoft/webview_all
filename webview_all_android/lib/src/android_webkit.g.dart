...
// ignore_for_file: unused_field, unused_import, unused_shown_name
...
class PigeonOverrides {
  ...
  static JavaScriptChannel Function({
    ...
    required void Function(JavaScriptChannel pigeon_instance, String message)
    postMessage,
  })?
  ...
  static WebViewClient Function({
    void Function(WebViewClient pigeon_instance, WebView webView, String url)?
    onPageStarted,
    void Function(WebViewClient pigeon_instance, WebView webView, String url)?
    onPageFinished,
    void Function(
    ...
    onFormResubmission,
    void Function(WebViewClient pigeon_instance, WebView view, String url)?
    onLoadResource,
    void Function(WebViewClient pigeon_instance, WebView view, String url)?
    onPageCommitVisible,
    void Function(
  ...
  static WebChromeClient Function({
    ...
    onProgressChanged,
    void Function(WebChromeClient pigeon_instance, PermissionRequest request)?
    onPermissionRequest,
    void Function(
      WebChromeClient pigeon_instance,
      View view,
    ...
    void Function(WebChromeClient pigeon_instance, ConsoleMessage message)?
    onConsoleMessage,
  ...
  /// Overrides [WebStorage.instance].
  static WebStorage? webStorage_instance;

  /// Overrides [WebView.setWebContentsDebuggingEnabled].
  ...
  static void pigeon_reset() {
    ...
    webView_new = null;
    webView_setWebContentsDebuggingEnabled = null;
    javaScriptChannel_new = null;
    webViewClient_new = null;
    downloadListener_new = null;
    webChromeClient_new = null;
...
class WebResourceError extends PigeonInternalProxyApiBaseClass {
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    WebResourceError Function(int errorCode, String description)?
    pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
...
class WebResourceErrorCompat extends PigeonInternalProxyApiBaseClass {
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    WebResourceErrorCompat Function(int errorCode, String description)?
    pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
...
class WebView extends View {
  ...
  Future<void> loadData(String data, String? mimeType, String? encoding) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[this, data, mimeType, encoding],
    );
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
  ...
  Future<bool> isDocumentStartJavaScriptSupported() async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _pigeonVar_codecWebView;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
  ...
  Future<void> addDocumentStartJavaScript(
    String identifier,
    String source,
  ) async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
  ...
  Future<void> removeDocumentStartJavaScript(String identifier) async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _pigeonVar_codecWebView;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
  ...
  Future<void> removeAllDocumentStartJavaScripts() async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _pigeonVar_codecWebView;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
...
class JavaScriptChannel extends PigeonInternalProxyApiBaseClass {
  factory JavaScriptChannel({
    ...
    return JavaScriptChannel.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      channelName: channelName,
      postMessage: postMessage,
  ...
  JavaScriptChannel.pigeon_new({
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[pigeonVar_instanceIdentifier, channelName],
    );
    () async {
      final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
  ...
  _pigeonVar_codecJavaScriptChannel = _PigeonInternalProxyApiBaseCodec(
    pigeon_instanceManager,
  );
  ...
  /// Alternatively, [PigeonInstanceManager.removeWeakReference] can be used to
  /// release the associated Native object manually.
  final void Function(JavaScriptChannel pigeon_instance, String message)
  postMessage;
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    void Function(JavaScriptChannel pigeon_instance, String message)?
    postMessage,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
    ...
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          try {
            (postMessage ?? arg_pigeon_instance.postMessage).call(
              arg_pigeon_instance,
              arg_message,
            );
            return wrapResponse(empty: true);
...
class WebViewClient extends PigeonInternalProxyApiBaseClass {
  factory WebViewClient({
    ...
    return WebViewClient.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      onPageStarted: onPageStarted,
      onPageFinished: onPageFinished,
  ...
  /// Alternatively, [PigeonInstanceManager.removeWeakReference] can be used to
  /// release the associated Native object manually.
  final void Function(WebViewClient pigeon_instance, WebView view, String url)?
  onLoadResource;
...
class WebChromeClient extends PigeonInternalProxyApiBaseClass {
  factory WebChromeClient({
    ...
    return WebChromeClient.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      onProgressChanged: onProgressChanged,
      onShowFileChooser: onShowFileChooser,
  ...
  /// Alternatively, [PigeonInstanceManager.removeWeakReference] can be used to
  /// release the associated Native object manually.
  final void Function(WebChromeClient pigeon_instance, ConsoleMessage message)?
  onConsoleMessage;
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final WebChromeClient arg_pigeon_instance =
              args[0]! as WebChromeClient;
          try {
            (onHideCustomView ?? arg_pigeon_instance.onHideCustomView)?.call(
              arg_pigeon_instance,
            );
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
...
class FlutterAssetManager extends PigeonInternalProxyApiBaseClass {
  ...
  late final _PigeonInternalProxyApiBaseCodec
  _pigeonVar_codecFlutterAssetManager = _PigeonInternalProxyApiBaseCodec(
    pigeon_instanceManager,
  );
...
class PermissionRequest extends PigeonInternalProxyApiBaseClass {
  ...
  late final _PigeonInternalProxyApiBaseCodec
  _pigeonVar_codecPermissionRequest = _PigeonInternalProxyApiBaseCodec(
    pigeon_instanceManager,
  );
...
class View extends PigeonInternalProxyApiBaseClass {
  ...
  Future<WebViewPoint> getScrollPosition() async {
    ...
    return pigeonVar_replyValue! as WebViewPoint;
  }
...
class GeolocationPermissionsCallback extends PigeonInternalProxyApiBaseClass {
  ...
  Future<void> invoke(String origin, bool allow, bool retain) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[this, origin, allow, retain],
    );
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
...
class SslError extends PigeonInternalProxyApiBaseClass {
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    SslError Function(SslCertificate certificate, String url)?
    pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
  ...
  Future<SslErrorType> getPrimaryError() async {
    ...
    return pigeonVar_replyValue! as SslErrorType;
  }
...
class SslCertificate extends PigeonInternalProxyApiBaseClass {
  ...
  Future<SslCertificateDName?> getIssuedBy() async {
    ...
    return pigeonVar_replyValue as SslCertificateDName?;
  }
  ...
  Future<X509Certificate?> getX509Certificate() async {
    ...
    return pigeonVar_replyValue as X509Certificate?;
  }
